...
using YazilimMuhendisligiOdev.RealtimeControllers.Constants;
using YazilimMuhendisligiOdev.RealtimeControllers.Models;
...
namespace YazilimMuhendisligiOdev.RealtimeControllers
{ 
    /// <summary>
